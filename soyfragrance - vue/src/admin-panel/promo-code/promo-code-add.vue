<template>
    ...
    <div class="home">
        <div class="home-content">
            <h1>Dodawanie kodów rabatowych</h1>
        </div>
    </div>
    <div class="event">
        <div class="event-content">
            <div class="event-form">
                <h2>Dodawanie kodów rabatowych</h2>
                <div class="input-full-width">
                    <input type="text" v-model="promoCode" placeholder="Wprowadź kod rabatowy">
                </div>
                <div class="input-full-width">
                    <input type="number" v-model="discount" placeholder="Wprowadź wartość kodu rabatowego">
                </div>
                <div class="input-full-width">
                    <input type="number" v-model="quantity" placeholder="Wprowadź ilość kodów rabatowych">
                </div>
                <div class="event-button">
                    <button class="event-btn" @click="addPromoCode">Dodaj kod rabatowy</button>
                </div>
            </div>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            addPromoCode() {
                ...
                if (!this.promoCode || !this.discount || !this.quantity)  {
                ...
                axios.post('http://localhost:8000/api/add-promo-code', formData, {
                    headers: {
                ...
                .then(response => {
                    ...
                    alert('Kod rabatowy dodany pomyślnie');
                    this.clearFields();
                })
                .catch(error => {
                    // Obsługa błędów
