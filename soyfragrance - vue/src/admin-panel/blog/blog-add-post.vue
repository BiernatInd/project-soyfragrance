        ...
        <div class="event-content">
            <div class="event-form">
                ...
                <div class="input-full-width">
                    <input type="text" v-model="articleTitle" placeholder="Wprowadź nazwę artykułu">
                </div>
                <div class="event-button">
                    <button class="event-btn" @click="addBlogPost">Dodaj wpis</button>
                </div>
            </div>
        </div>
    </div>
...
import axios from 'axios'
    ...
    export default {
        ...
        addBlogPost() {
            ...
            console.log("Wysyłanie wpisu:", this.articleTitle);
            ...
            .then(response => {
                this.slug = response.data.slug;  // Zmieniono tutaj również
                console.log(response.data.message);
                alert('Wpis dodany pomyślnie');
                this.$router.push(`/blog-dodaj-zdjecie/${this.slug}`);  // I tutaj również
            })
            .catch(error => {
