        ...
        <div class="event-content" v-if="orderType === 'private_person'" id="private_person">
            ...
            <div class="event-right">
                <div class="event-right-top">
                    ...
                    <p>Numer paczkomatu: {{ order.paczkomat_number || 'Brak danych' }}</p>
                ...
                <div class="event-right-bottom">
                    ...
                    <select v-model="newOrderStatus">
                        ...
                        <option value="Nieopłacono">Nieopłacono</option>
                    </select>
                    <div class="event-right-bottom-button">
                      <button class="event-right-bottom-btn"  @click="showConfirmation">Zmień status</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="confirmation-main">
            ...
            <div class="confirmation-bottom">
                ...
                <div class="confirmation-buttons">
                    ...
                    <button class="confirmation-btn" @click="updateOrderStatus">Zmień status</button>
                </div>
            </div>
        </div>
      </div>
...
import axios from 'axios'
    ...
    export default {
        ...
        data() {
            return {
                ...
                order: {},
                newOrderStatus: '',
                statusOptions: ['Zrealizowano', 'Opłacono', 'Nieopłacono'],
            }
        },
        methods: {
  ...
  updateOrderStatus() {
    ...
    axios.put(`http://localhost:8000/api/update-availability/${orderNumber}`, {
      new_order_status: this.newOrderStatus, // Upewnij się, że ta wartość istnieje i jest przekazywana
    })
      .then(response => {
