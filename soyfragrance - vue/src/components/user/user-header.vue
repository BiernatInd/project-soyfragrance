<template>
   <header class="header">
       <nav class="nav">
           ...
           <div class="nav-right">
                <div class="nav-menu" @click="toggleUserMenu" :class="{ 'active': userMenuActive}">
               ...
               <svg width="41" height="41" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg" @click="toggleUserAuthMenu" :class="{'active': userAuthMenuActive}"> 
...
<script>
import UserAuthMenu from './user-auth-menu.vue'
...
export default {
   ...
   computed: {
    ...mapState(['userMenuActive', 'userAuthMenuActive'])
   },
   methods: {
    ...mapActions(['setUserMenuActive', 'setUserAuthMenuActive']),
  toggleUserMenu() {
